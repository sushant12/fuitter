...
Rails.application.config.sorcery.submodules = [:external, :activity_logging, :user_activation]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
   config.facebook.key = ENV['1354728827916287']
   config.facebook.secret = ENV['4412667c2bed46b3ed06d8989305c766']
   ...
   config.facebook.access_permissions = ["email", "manage_pages"]
